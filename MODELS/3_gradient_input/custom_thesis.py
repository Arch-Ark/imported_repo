...
for arr in loaded_arrays:
    test_digit = loaded_arrays[arr]
    test_digit = compute_gradient_magnitude(test_digit.reshape(28,28))
    ...
    confidence.append(pred[0].max())

print(f'answers: {answers}')
print(f'confidence: {sum(np.array(confidence))/len(confidence)}')